...
from utils import CustomDataset, compute_ece, visualize_embeddings_with_tsne, augment
...
model_load_path = "/root/project/Representational-Learning/saved_model.pth"
...
dataset = load_from_disk("/root/project/Representational-Learning/dataset/val")
# custom_dataset = CustomDataset(dataset, preprocess)
custom_dataset = CustomDataset(dataset, preprocess, augment=augment)
